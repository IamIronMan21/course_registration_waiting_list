...
public class MyAdapterEdit extends RecyclerView.Adapter<com.example.courseregistrationwaitinglist.MyAdapterEdit.MyViewHolder>{
    ...
    @NonNull
    @Override
    public com.example.courseregistrationwaitinglist.MyAdapterEdit.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_edit,parent,false);
        return new com.example.courseregistrationwaitinglist.MyAdapterEdit.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.courseregistrationwaitinglist.MyAdapterEdit.MyViewHolder holder, int position) {
...
//        holder.Priority.setText(String.valueOf(Priority.get(position)));
        ...
        message_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(context,Course_Registration.class);
